...
const Page1 = () => {
  ...
  return (
    <div className="relative overflow-hidden">
      {/* Section 1 */}
      <div className="first w-full h-screen bg-[#ff0202] mix-blend-overlay z-10 flex">
        <div className="contrast-200 w-full h-full flex flex-col justify-end items-end p-4 sm:p-8 md:p-12">
          <svg
      ...
      {/* Section 2 */}
      <div className="first-2 w-full h-screen bg-transparent" />
    </div>
  );
};
